...
// export const OutputBox: React.FC<OutputBoxProps> = ({ content, blocked, detectionResult, intentVerification, processingTime, isLoading }) => {
//   return (
...
//               )} && (
//           <div>
//             <p className={blocked ? 'text-red-600' : 'text-gray-900'}>{content}</p>
...
//           <svg className="animate-spin h-5 w-5 text-[#007185]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
